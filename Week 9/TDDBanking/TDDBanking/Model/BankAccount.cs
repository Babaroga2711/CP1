...
public class BankAccount
{
    ...
    public BankAccount(string accountNumber, string owner, decimal initialBalance)
    {
        ...
        Owner = owner;
        var intitialDeposit = new Transaction(AccountNumber, 
            initialBalance, DateTime.Now, TransactionType.Deposit,
            "Opening Account Balance");
        _allTransactions.Add(intitialDeposit);
    ...
    public void MakeWithdrawal(decimal amount, DateTime date, string note)
    {
        ...
        if(-amount > Balance)
        {
            throw new ArgumentException("You cannot withdraw more money than you have on your account");
        }
        var withdrawal = new Transaction(AccountNumber, 
