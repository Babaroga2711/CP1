...
namespace GamblersRuin
{
    ...
    ///<summary>
    /// This edited example of Gambler's Ruin has been corrected using code analysis tools incorporated in Visual Studio
    /// The class Gambler starts by asking player for their starting
    ///</summary>
    public static class Gambler
    {
        private static int s_bets = 0;
        static private int s_gameWins = 0;
        private static int s_winningThrows = 0;
        static private string s_play_again_response = "Y";
